...
{
	public class DocumentoFacturacionService : IDocumentoFacturacionService
	{
		private readonly IDocumentoFacturacionRepository _repository;
		...
		public DocumentoFacturacionService(
			IDocumentoFacturacionRepository repository,
